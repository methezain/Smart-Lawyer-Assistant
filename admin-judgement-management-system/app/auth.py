"""
JWT Authentication utilities for Judgments Management System.
Mirrors the auth used by Cases/Hearings services.
"""
import os
import jwt
import logging
...
def get_current_user(credentials: HTTPAuthorizationCredentials = Depends(security)) -> JWTTokenData:
    ...
    try:
        ...
        return JWTTokenData(user_id=user_id, username=username, firm_id=firm_id, user_type=user_type)
