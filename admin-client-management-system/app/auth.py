"""
JWT Authentication utilities for Client Management System.
...
# JWT settings - Must match the Admin Registration service settings
...
def decode_jwt_token(token: str) -> Optional[Dict[str, Any]]:
    ...
    Returns:
        Optional[Dict[str, Any]]: Decoded payload or raises HTTPException if invalid
    """
    try:
        logger.info(
