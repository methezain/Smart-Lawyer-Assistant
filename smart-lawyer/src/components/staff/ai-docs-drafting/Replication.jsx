...
const fields = [
  ...
  {
    id: "replyToObjections",
    label: "Reply to Objections",
    type: "textarea",
    required: false,
  },
  {
    id: "replyToDenials",
    label: "Reply to Denials",
    type: "textarea",
    required: true,
  },
  {
    id: "additionalSubmissions",
    label: "Additional Submissions",
    type: "textarea",
    required: false,
  },
...
const generateDocument = (d) =>
  `IN THE COURT OF ${d.courtName}\n\nCase No. ${d.caseNumber}\n\n${
    ...
    d.replyToObjections || "[None]"
  }\n\nII. REPLY TO DENIALS:\n${
    d.replyToDenials
  }\n\nIII. ADDITIONAL SUBMISSIONS:\n${
    d.additionalSubmissions || "[None]"
...
const Replication = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setGenerated({
        title: `Replication - ${formData.caseNumber}`,
                ...
                <div className="bg-emerald-50 p-2.5 rounded-xl mb-4 flex justify-start items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-emerald-600">
                      Standard template for replication
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden text-sm border border-gray-200 p-4 sticky top-0">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600 text-xs">Replication</p>
              </div>
              <div>
                <h4 className="text-xs font-semibold text-gray-700 mb-0.5">
                  Description
                ...
                <p className="text-gray-600 text-xs">
                  A plaintiff's response to a defendant's written statement
                </p>
              </div>
              <div>
                <h4 className="text-xs font-semibold text-gray-700 mb-0.5">
              ...
              <div className="border-t border-gray-100 pt-4">
                ...
                <ul className="text-gray-600 text-xs mt-2 space-y-1">
                  <li className="flex items-start">
                    ...
                    <span>Address each objection clearly.</span>
                  </li>
                  <li className="flex items-start">
                    <i className="ri-information-line text-blue-500 mr-2" />
                    <span>Support replies with brief facts.</span>
                  </li>
                  <li className="flex items-start">
                    <i className="ri-information-line text-blue-500 mr-2" />
