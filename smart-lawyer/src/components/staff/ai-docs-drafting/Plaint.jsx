...
const fields = [
  { id: "plaintNumber", label: "Plaint Number", type: "text", required: true },
...
const Plaint = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setGenerated({
        title: `Plaint - ${formData.plaintNumber}`,
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden text-sm border border-gray-200 p-4 sticky top-0">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600 text-xs">Plaint</p>
              </div>
              <div>
                <h4 className="text-xs font-semibold text-gray-700 mb-0.5">
                  Description
                ...
                <p className="text-gray-600 text-xs">
                  A legal document that starts a lawsuit
                </p>
              </div>
              <div>
                <h4 className="text-xs font-semibold text-gray-700 mb-0.5">
              ...
              <div className="border-t border-gray-100 pt-4">
                ...
                <ul className="text-gray-600 text-xs mt-2 space-y-1">
                  ...
                  <li className="flex items-start">
                    <i className="ri-information-line text-blue-500 mr-2 mt" />
