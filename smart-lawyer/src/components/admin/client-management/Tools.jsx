...
// Custom Dropdown Component (styled like Documents Tools)
...
const Tools = ({
  ...
  return (
    <div className="bg-white rounded-xl p-3 text-xs shadow-sm mb-6">
      <div className="flex flex-col lg:flex-row gap-3 items-start lg:items-center">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className={`pl-6 pr-3 w-full ${inputCls}`}
            value={searchTerm}
        ...
        <div>
          <CustomDropdown
            ...
            onChange={(val) => onFilterTypeChange && onFilterTypeChange(val)}
            options={[
        ...
        <div>
          <CustomDropdown
            ...
            onChange={(val) =>
              onFilterStatusChange && onFilterStatusChange(val)
            }
            options={[
        ...
        <div>
          <CustomDropdown
            ...
            onChange={(val) =>
              onFilterGenderChange && onFilterGenderChange(val)
            }
            options={[
        ...
        <div className="flex-0">
          <button
            onClick={onAddClient}
            className="px-4 py-2 bg-emerald-600 whitespace-nowrap  text-white rounded-lg hover:bg-emerald-700 flex items-center gap-2"
          >
            <i className="ri-user-add-line"></i> Add New Client
          </button>
        </div>
      </div>
    </div>
